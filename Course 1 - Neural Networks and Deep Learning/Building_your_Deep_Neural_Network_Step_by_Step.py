...
def L_model_forward(X, parameters):
    ...
    for l in range(1, L):
        A_prev = A 
        #print("SIZE OF W"+str(l))
        #print(np.shape(parameters["W"+str(l)]))
        #print("SIZE OF A_PREV")
        #print(np.shape(A_prev))
        #print("SIZE OF b"+str(l))
        #print(np.shape(parameters["b"+str(l)]))
        #(≈ 2 lines of code)
        # A, cache = ...
        # caches ...
        # YOUR CODE STARTS HERE
   ...
   # print("----------------------------")
    #print(caches[1][0][2])
    #print("shape of caches")
    #print(np.shape(caches))
    #print("----------------------------")
    #print(np.shape(caches[1][0]))
    #print("----------------------------")
    #print(np.shape(caches[1][1]))
