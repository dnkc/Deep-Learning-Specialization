...
def sentence_to_avg(sentence, word_to_vec_map):
    ...
    #print("avg shape", avg.shape, "avg", avg)
    ...
    for w in words:
        ...
        #print("w, word_to_vec_map[w].shape and word_to_vec_map[w]", w, word_to_vec_map[w].shape, word_to_vec_map[w])
...
x_test = np.array(['I do not feel happy'])
X_test_indices = sentences_to_indices(x_test, word_to_index, maxLen)
